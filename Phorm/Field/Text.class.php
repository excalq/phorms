...
class Phorm_Field_Text extends Phorm_Field
{
	...
	/**
	 * Specifies that this field's name attribute must be post-fixed by [] if set to true.
	 * @var boolean
	 */
	public $multi_field;
	 ...
	 * @param array $multi_field should the field names end in [] (useful for multiple row inputs of the same name)
	 */
	public function __construct($label, $size, $max_length, array $validators=array(), array $attributes=array(), $multi_field=false)
	{
